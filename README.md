...
2. The app will be handed over to the production team
3. The production release will use a different bundle identifier

Do not use this testing bundle identifier for production releases.
